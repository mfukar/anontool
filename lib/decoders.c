...
char           *http_keywords[] =
	...
	"Accept-Language", "Accept-Ranges", "Age", "Allow", "Authorization", "Cache-Control",
	    "Connection",
	"Content-Type", "Content-Length", "Content-Location", "Content-MD5", "Content-Range",
	    "Cookie", "Etag",
	...
	"Proxy-authorization", "Range", "Referer", "Retry-after", "Set-Cookie", "Server", "Te",
	    "Trailer",
	"Transfer-encoding", "Upgrade", "Via", "Warning", "WWW-authenticate", "X-powered-by",
	    "Response code",
	"Code description", "Vary", "Date", "Content-Encoding", "Keep-Alive", "Location", "Payload"
};

char           *ftp_keywords[] =
    { "USER", "PASS", "ACCT", "TYPE", "STRU", "MODE", "CWD", "PWD", "CDUP", "PASV", "RETR", "REST",
"PORT",
	"LIST", "NLST", "QUIT", "SYST", "STAT", "HELP", "NOOP", "STOR", "APPE", "STOU", "ALLO",
	    "MKD", "RMD",
