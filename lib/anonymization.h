...
typedef enum  {
	...
	FLOWSET_ID		, 	// 0 for record that describes flow fields, 1 for template options.
	...
	IN_PERMANENT_PKTS	,
	VENDOR_87		,
	NF9_FRAGMENT_OFFSET	, // prefix(NF9) is due to conflict with previously declared IP field.
	FORWARDING_STATUS	,
